...
class ShoppingFarm.Admin.Views.Manufacturers.NewView extends Backbone.View
  template: JST["backbone_admin/templates/manufacturers/new"]
  
  events: "submit #manufacturer" : "save"
